...
<
    div id="we_exist" className="row about">
        ...
        <div className="col-6">
            <p className="Col_text_right">Having experienced the difficulties involved in sourcing reliable medical equimpnet in different parts of the world - first hand - we're here to help you source the equipment you need, at the grade you require and at the price that works for your budget. <a href="#" className ="textLINK_MORE"><i>See our services</i></a>.</p>
        </div>
